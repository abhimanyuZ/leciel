...
<title>Accomodation Registration Form</title>
...
<body>
<form class="jotform-form" action="#" method="post" name="form_rabble" id="82563732082457" accept-charset="utf-8">
      ...
      <li class="form-line jf-required" data-type="control_spinner" id="id_18">
        ...
        <div id="cid_18" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="input_18" style="min-height:13px"> If any </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_spinner" id="id_21">
        ...
        <div id="cid_21" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="input_21" style="min-height:13px"> If any </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_spinner" id="id_22">
        ...
        <div id="cid_22" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="number" id="input_22" name="q22_numberOf22" data-type="input-spinner" class="form-spinner-input  form-textbox validate[required]" value="0" data-component="spinner" required="" />
            <label class="form-sub-label" for="input_22" style="min-height:13px"></label>
          </span>
        </div>
      </li>
