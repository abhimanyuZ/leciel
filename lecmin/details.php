<?php
	...
	include "../php/qrcode/phpqrcode/qrlib.php";
   
    QRcode::png('http://lecielfest.com/lecmin/details.php?q='.$lid.'', '../php/qrcode/image/'.$lid.'QR.png', 'L', 10, 2);
...
<body>
<hr>
<h3><a href="sessionDestroy.php">logout</a></h3>
<hr>
<div class="container bootstrap snippet">
    <div class="row">
        ...
        <div class="col-sm-2">
            <center> <?php echo "<img src='../php/qrcode/image/".$lid."QR.png' title='QRcode' id ='userQR' class='img-responsive' >";?>
           	<a href="<?php echo '../php/qrcode/image/'.$lid.'QR.png'; ?>" download >Download QR Code</a><br><p class="alert alert-info ">Bring this along with you</p>
            </center>
        </div>
    </div>
    <br><br>
