...
<head>
<meta charset="UTF-8">
<title>Le Ciel NIT Puducherry Cultural Fest</title>
...
if (screen.width <= 699) {
document.location = "mobile/nav/index.php";
}
...
<!--first page-->
<div id="ScrollPane">
   <div class="scr pane prt" style="  background: radial-gradient(ellipse at bottom, #1b2735 0%, #090a0f 100%);" data-id="Welcome">
     <div id='stars2'></div>
    <div id='stars3'></div>
    ...
    <nav role="navigation" class="menu">
    		...
    		<a href="#" class="logotype">Le<span>Ciel</span></a>
...
<em>minimum 6 characters</em>
            ...
            <!-- Button -->
             ...
             <div class="control-group">
              ...
              <div id="incorrect" style="color: red !important; font-style: italic;" ></div>
              <div class="controls">
                <button id="signin" name="signin" class="btn btn-primary btn-block ajax-button">Log In</button>
              </div>
            </div>
        </div>
...
<div class="modal fade bs-modal-sm log-sign" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-sm">
         ...
         <div class="modal-body">
            <div id="myTabContent" class="tab-content">
               <div class="tab-pane fade active in" id="signin2">
                  ...
                  <div class="control-group">
              <label class="control-label" for="signin"></label>
              <div id="incorrect2" style="color: red !important; font-style: italic;" ></div>
              <div class="controls">
                <button name="signin33" class="btn btn-primary btn-block" id="ajax-button2">Log In</button>
              </div>
            </div>
      ...
      <!--login-->
      <center>   <!--Video Button-->
      <button class="button" id="youtube" type="button" title="Le Ciel Promo"></button></center>
   ...
   <div class="scr prt horiz">
      <div class="spane">
         <div class="pane an"  data-id="Horizontal01">
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        <div class="left-banner-content">
                           <div class="text-content">
                              ...
                              <h1>“Dance is the hidden language of the soul”<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp― Martha Graham </h1>
                     ...
                     <div class="col-md-4">
                        <div class="right-banner-content">
                           <div class="logo"><a href="index.html"><img src="img/logo.png" alt="" height="200" width="120" ></a></div>
                           <br>
                           <h2>Dance</h2>
                           <span>Step <strong>Up</strong> To The beat</span>
                           <div class="line-dec"></div>
                           <p>Natyashastra or Horos<br> Classical mudras or Bollywood dumkas<br> Show off here at Step Up  </p>
                           <br>
                           <div class="white-border-button">
                              <a href="eventcards/dance.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="pane an"  data-id="Horizontal02">
            <!--Music-->
            <section class="banner" id="top">
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="right-banner-content" id="musicright">
                           <div class="logo"><a href="index.html"><img src="img/music.png" alt="" height="175" width="110" ></a></div>
                           <br>
                           <h2>Music</h2>
                           <span>Bring <strong>music</strong> to life</span>
                           <div class="line-dec"></div>
                           <p>Art form Muses. Melody or Harmonies.<br> Hard rock or Orchestra. This is the place!</p>
                           <br>
                           <div class="white-border-button">
                              <a href="eventcards/music.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="pane an"  data-id="Horizontal03">
            <!--Art-->
            <section class="banner" id="top">
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="right-banner-content" id="artright">
                           <div class="logo"><a href="index.html"><img src="img/art.png" alt="" height="190" width="190" ></a></div>
                           <br>
                           <h2>Fun & Arts</h2>
                           <span>Where<strong> imagination </strong>and <strong>Creativity</strong><br>come to Life</span>
                           <div class="line-dec"></div>
                           <p>"A picture Paints a Thousand words"<br> Do you wish to bring your thoughts to life ?<br> and have some fun along the road<br> Then this is the place.</p>
                           <br>
                           <div class="white-border-button">
                              <a href="eventcards/art.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="pane an" data-id="Horizontal04">
            <!--Literature-->
            <section class="banner" id="top">
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="right-banner-content" id="litright">
                           <div class="logo"><a href="index.html"><img src="img/literature.png" alt="" height="190" width="190" ></a></div>
                           <br>
                           <h2>Literature</h2>
                           <span>Where <strong>Fiction</strong> and <strong>Reality</strong> Coalesce</span>
                           <div class="line-dec"></div>
                           <p>Spoken or Written. Fiction or non fiction.<br>Is your imagination at its peak?<br> Then be here !   </p>
                           <br>
                           <div class="white-border-button">
                              <a href="eventcards/literature.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="pane an" data-id="Horizontal05">
            <!---theatrical-->
            <section class="banner" id="top">
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="right-banner-content" id="thright">
                           <div class="logo"><a href="index.html"><img src="img/theatrical.png" alt="" height="160" width="200" ></a></div>
                           <br>
                           <h2>Theatrical</h2>
                           <span>Bringing the <strong>stage</strong> to life</span>
                           <div class="line-dec"></div>
                           <p>Silent Comedy or Short feature.<br>Can you Stirr the crowd?<br> The stage is yours then!</p>
                           <br>
                           <div class="white-border-button">
                              <a href="eventcards/theatrical.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="pane an" data-id="Horizontal06">
            <!--Online-->
            <section class="banner" id="top">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-8">
                        <div class="left-banner-content" id="onlinepic">
                           <div class="text-content">
                              ...
                              <h1>“Photography takes an instant out of time,<br> altering life by holding it still.”<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp– Dorothea Lange</h1>
                     ...
                     <div class="col-md-4">
                        <div class="right-banner-content" id="onlineright">
                           <div class="logo"><a href="index.html"><img src="img/online.png" alt="" height="190" width="190" ></a></div>
                           <br>
                           <h2>Online</h2>
                           <span></span>
                           <div class="line-dec"></div>
                           <p><br><div class="white-border-button">
                              <a href="eventcards/online.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                           </div></p>
           ...
           <div class="row">
              <div class="col-md-8">
                 <div class="left-banner-content" id="hpic">
                    <div class="text-content">
                       ...
                       <h1>True hospitality consists of giving<br> the best of yourself to your guests. <br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp- Eleanor Roosevelt </h1>
                       <div class="white-border-button">
                          <a href="hospitality/index.html" class="scroll-link" data-id="best-offer-section">Read More</a>
                       </div>
                    </div>
                 </div>
              </div>
              <div class="col-md-4">
                 <div class="right-banner-content" id="hright">
                    <div class="logo" ><a href="index.html"><img src="img/hosp.png" alt="" height="160" width="200" ></a></div>
                    <br>
                    <h2>Hospitality</h2>
   ...
   <div class="scr pane prt an" data-id="Conclusion">
     <div class="section">
...
<div id="Helper"></div>
  ...
  $("#ajax-button2").on("click",function()
  {
    var resp = -1;
    window.stop();
