...
<title>Rythm Gods Event Registration </title>
...
<script type="text/javascript">
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo14","qid":"14","text":"Rhythm Gods Event Registration","type":"control_head"},null,null,null,null,null,{"name":"submit","qid":"20","text":"Submit","type":"control_button"},{"description":"","name":"typeA","qid":"21","subLabel":"","text":"Team Name","type":"control_textbox"},null,{"description":"","name":"typeA23","qid":"23","subLabel":"maximum of 6","text":"No. of Participants","type":"control_spinner"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo14","qid":"14","text":"Rhythm Gods Event Registration","type":"control_head"},null,null,null,null,null,{"name":"submit","qid":"20","text":"Submit","type":"control_button"},{"description":"","name":"typeA","qid":"21","subLabel":"","text":"Team Name","type":"control_textbox"},null,{"description":"","name":"typeA23","qid":"23","subLabel":"maximum of 6","text":"No. of Participants","type":"control_spinner"}]);}, 20);
</script>
</head>
<body>
<form class="jotform-form" action="../../e_reg.php" method="post" name="form_gds" id="82563845182463" accept-charset="utf-8">
        ...
        <div class="form-header-group ">
          <div class="header-text httal htvam">
            <h1 id="header_14" class="form-header" data-component="header">
              Rhythm Gods Event Registration
            </h1>
          </div>
        </div>
      </li>
        ...
        <div id="cid_21" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_21" name="promo" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" />
              <input type="hidden" name="event" value="14">
      ...
      <li class="form-line" data-type="control_spinner" id="id_23">
        ...
        <div id="cid_23" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="input_23" style="min-height:13px"> maximum of 6 </label>
          </span>
        </div>
      </li>
