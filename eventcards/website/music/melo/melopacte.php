...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F82563845182463" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F82563845182463" title="oEmbed Form">
<meta property="og:title" content="Clone of single Registration " >
<meta property="og:url" content="https://form.jotform.me/82563845182463" >
<meta property="og:description" content="Please click the link to complete this form.">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<link rel="canonical" href="https://form.jotform.me/82563845182463" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<meta name="HandheldFriendly" content="true" />
<title>Melopacte Event Registration Form</title>
...
<script type="text/javascript">
   ...
   JotForm.init(function(){
    $('input_23').spinner({ imgPath:'https://cdn.jotfor.ms/images/', width: '60', maxValue:'', minValue:'', allowNegative: false, addAmount: 1, value:'' });
    /*INIT-END*/
});

   JotForm.prepareCalculationsOnTheFly([null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo14","qid":"14","text":"Melopacte Event Registration","type":"control_head"},null,null,null,null,null,{"name":"submit","qid":"20","text":"Submit","type":"control_button"},{"description":"","name":"typeA","qid":"21","subLabel":"","text":"Team Name","type":"control_textbox"},null,{"description":"","name":"typeA23","qid":"23","subLabel":"maximum of 10","text":"No. of Participants","type":"control_spinner"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo14","qid":"14","text":"Melopacte Event Registration","type":"control_head"},null,null,null,null,null,{"name":"submit","qid":"20","text":"Submit","type":"control_button"},{"description":"","name":"typeA","qid":"21","subLabel":"","text":"Team Name","type":"control_textbox"},null,{"description":"","name":"typeA23","qid":"23","subLabel":"maximum of 10","text":"No. of Participants","type":"control_spinner"}]);}, 20);
</script>
</head>
<body>
<form class="jotform-form" action="../../e_reg.php" method="post" name="form_melo" id="82563845182463" accept-charset="utf-8">
  <input type="hidden" name="formID" value="82563845182463" />
  <div class="form-all">
        ...
        <div class="form-header-group ">
          <div class="header-text httal htvam">
            <h1 id="header_14" class="form-header" data-component="header">
              Melopacte Event Registration
            </h1>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_21">
        <label class="form-label form-label-left form-label-auto" id="label_21" for="input_21"> Promo Code </label>
        <div id="cid_21" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_21" name="promo" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" />
              <input type="hidden" name="event" value="15">
            <label class="form-sub-label" for="input_21" style="min-height:13px"> If Any Received </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_21">
        <label class="form-label form-label-left form-label-auto" id="label_21" for="input_21"> Team Name </label>
        <div id="cid_21" class="form-input">
          <input type="text" id="input_21" name="team_name" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" />
        </div>
      </li>
      <li class="form-line" data-type="control_spinner" id="id_23">
        <label class="form-label form-label-left form-label-auto" id="label_23" for="input_23"> No. of Participants </label>
        <div id="cid_23" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="number" id="input_23" name="no_mem" data-type="input-spinner" class="form-spinner-input  form-textbox" value="" data-component="spinner" />
            <label class="form-sub-label" for="input_23" style="min-height:13px"> maximum of 10 </label>
          </span>
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="82563845182463" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "82563845182463-82563845182463";
  </script>
