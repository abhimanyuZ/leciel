...
<title>Short Film Event Registration Form</title>
...
<body>
<form class="jotform-form" action="../../e_reg.php" method="post" name="form_film" id="82563845182463" accept-charset="utf-8">
  ...
  <div class="form-all">
    <ul class="form-section page-section">
        ...
        <div id="cid_19" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_19" name="promo" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" />
              <input type="hidden" name="event" value="16">
      ...
      <li class="form-line" data-type="control_spinner" id="id_23">
        <label class="form-label form-label-left form-label-auto" id="label_23" for="input_23"> No. of Members </label>
        <div id="cid_23" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="input_23" style="min-height:13px"> </label>
          </span>
        </div>
      </li>
