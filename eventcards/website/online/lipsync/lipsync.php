...
<title>Lip-Synchro Registration Form</title>
...
<body>
<form class="jotform-form" action="../../e_reg.php" method="post" name="form_lipsynch" id="82563497082465" accept-charset="utf-8">
        ...
        <div class="form-header-group ">
          <div class="header-text httal htvam">
            <h1 id="header_14" class="form-header" data-component="header">
              Lip-Synchro Event Registration
            </h1>
          </div>
        </div>
      </li>
